...
const eventDatabasePath = 'C:\Users\VISVESWAR\frontendproject\src\Components\EventDatabase.js';

// Your code for updating the EventDatabase.js file
let jsCode = `// ${eventDatabasePath}\n`;
